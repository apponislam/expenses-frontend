...
// Updated Data
const chartData = [
    { month: "Jan", revenue: 470000, subscriptions: 550000, advertisements: 320000 },
    { month: "Feb", revenue: 460000, subscriptions: 305000, advertisements: 505000 },
            ...
            <div className="h-[190px]">
                <ResponsiveContainer width="100%" height="100%">
                    <ComposedChart data={chartData} barSize={24} barGap={4}>
                        ...
                        <Line type="monotone" dataKey="subscriptions" stroke={chartConfig.subscriptions.color} strokeWidth={2} dot={{ r: 3 }} activeDot={{ r: 5 }} />

                        {/* Line: Advertisement Revenue */}
                        <Line type="monotone" dataKey="advertisements" stroke={chartConfig.advertisements.color} strokeWidth={2} dot={{ r: 3 }} activeDot={{ r: 5 }} />
                    </ComposedChart>
                </ResponsiveContainer>
            </div>
        </ChartContainer>
